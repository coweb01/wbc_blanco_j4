    ...
    <div class="wbc-fixed-sidebar-<?php echo $side; ?> d-none d-sm-block">
      ...
      <div class="d-inline-block">
        <div id="icon-<?php echo $side; ?>-search" class="d-print-none wbc-h-xlarge d-flex">
          <a class="nav-link shadow-sm mb-2" title="<?php echo JText::_('COM_SEARCH_SEARCH');?>" href="<?php echo  $searchsite; ?>" aria-label="Seite durchsuchen"><i class="<?php echo $faclass; ?> fa-search" aria-hidden="true"><span class="visually-hidden visually-hidden-focusable"><?php echo JText::_('COM_SEARCH_SEARCH'); ?></span></i></a>
        </div>
      </div>
    </div>
    <?php endif; ?>
    ...
    <?php if ( $toggle ) :?>
            ...
            <?php if ( $jhtml->countModules('sidebar-'. $side .'-toggle') ||
              ...
              <div id="fixed-sidebar-<?php echo $side; ?>-toggle" class="wbc-fixed-sidebar-toggle d-none d-sm-block">
                   ...
                   <a class="toggle-btn nav-link btn-icon shadow-sm" role="button" href="#" aria-label="Button"><i class="<?php echo ($side == 'left') ? $iconleft : $iconright;?>"></i> <span class="visually-hidden"><?php echo JText::_('TPL_WBC_BLANCO_J3_OPEN_TXT'); ?></span></a>
