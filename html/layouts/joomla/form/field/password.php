 ...
 * 
 * Template Override for Floating Labels
 */
...
// Ensure placeholder is set for floating labels
if (!$hint && !empty($label)) {
    $hint = strip_tags($label);
}
...
?>
<?php if ($rules) : ?>
    <div id="<?php echo $name . '-rules'; ?>" class="bg-light small text-muted mb-2 p-2 password-rules">
        <?php echo Text::sprintf('JFIELD_PASSWORD_RULES_MINIMUM_REQUIREMENTS', implode(', ', $requirements)); ?>
    </div>
<?php endif; ?>

<div class="password-group password-floating">
    <div class="input-group">
        <div class="form-floating flex-grow-1">
            ...
            <label for="<?php echo $id; ?>"><?php echo $label; ?><?php if ($required) : ?><span class="star text-danger" aria-hidden="true">&nbsp;*</span><?php endif; ?></label>
            <?php if (!$lock) : ?>
