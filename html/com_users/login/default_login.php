...
<div class="com-users-login login">
    ...
    <div class="page-header">
        <h2>
            <?php echo Text::_('WBC_BLANCO_COM_USER_LOGIN'); ?>
        </h2>
    </div>
    <?php endif; ?>
    ...
    <form action="<?php echo Route::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="com-users-login__form form-validate form-horizontal card mb-5" id="com-users-login__form">
        <div class="card-body">
            <fieldset>
                ...
                <?php endif; ?>
                <div class="btn-toolbar my-3" role="toolbar" aria-label="Button Gruppe">
