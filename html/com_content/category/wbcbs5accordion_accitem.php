...
<div class="wbc__accitem-content accordion-body">
    ...
    <?php if ( $link_titles ) { ?>
        ...
        <a class="wbc__itemlink d-flex justify-content-between " href="<?php echo Route::_(RouteHelper::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language)); ?>">
