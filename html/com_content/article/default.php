...
$imgclass          = empty($images->float_fulltext) ? 'image-'.$params->get('float_fulltext') : 'image-'.$images->float_fulltext;
?>
<div class="com-content-article item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
    ...
    <div itemprop="articleBody" class="com-content-article__body <?php echo $imgclass;?>">
        <?php echo LayoutHelper::render('joomla.content.full_image', $this->item); ?>
        <div class="article-body"><?php echo $this->item->text; ?>
