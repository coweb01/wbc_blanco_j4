...
?><a <?php echo $class; ?><?php echo $htmlaccesskey; ?>href="<?php echo $item->flink; ?>" target="_blank" <?php echo $title; ?>><span class="chrome-fix" ><?php echo $linktype; ?></span><?php echo $htmlsubtitle;?></a><?php
	...
	case 2:
		...
		$options = 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,'.$params->get('window_open');
			?><a <?php echo $class; ?><?php echo $htmlaccesskey; ?>href="<?php echo $item->flink; ?>" onclick="window.open(this.href,'targetWindow','<?php echo $options;?>');return false;" <?php echo $title; ?>><span class="chrome-fix"><?php echo $linktype; ?></span><?php echo $htmlsubtitle;?></a><?php
		break;
endswitch;
