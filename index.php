...
<body id="top" class="body-01 <?php echo $classbody; ?>">
 <div class="prevent-scrolling">
  ...
  <ul class="sr-only sr-only-focusable">
    <li><a href="#wrap-content" class="sr-only sr-only-focusable"><?php echo JText::_('TPL_WBC_BLANCO_J4_SKIP_TO_CONTENT'); ?></a></li>
    <li><a href="#navigation-main" class="sr-only sr-only-focusable"><?php echo JText::_('TPL_WBC_BLANCO_J4_SKIP_TO_MAIN_NAVIGATION'); ?></a></li>
    <?php if ($this->countModules('header-top-01') ) { ?><li><a href="#header-top-01" class="sr-only sr-only-focusable"><?php echo JText::_('TPL_WBC_BLANCO_J4_SKIP_TO_TOP_NAVIGATION'); ?></a></li><?php } ?>
    <?php if($showleftColumn) { ?><li><a href="#sidebar-left" class="sr-only sr-only-focusable"><?php echo JText::_('TPL_WBC_BLANCO_J4_JUMP_TO_LEFT_INFORMATION'); ?></a></li><?php } ?>
    <?php if($showrightColumn) { ?><li><a href="#sidebar-right" class="sr-only sr-only-focusable"><?php echo JText::_('TPL_WBC_BLANCO_J4_JUMP_TO_RIGHT_INFORMATION'); ?></a></li> <?php } ?>
    <li><a href="#suche" class="sr-only sr-only-focusable"><?php echo JText::_('TPL_WBC_BLANCO_J4_JUMP_TO_SEARCH'); ?></a></li>
  </ul>
  <!-- end Accesibility -->
  ...
  <header class="header" >
    ...
    <div class="header-top <?php echo ( $fixedheader == 1 ) ? 'sps' :'';?>"  >
      <div class="container<?php  echo ( $navbarHeaderWidth == 1 ) ? '-fluid' : '';?>">
        ...
        <?php  $LayoutLogo     = new JLayoutFile('wbc_blanco_template.logopos', $tpath.'/html/layouts');
        ...
        <nav id="navigation-main"  >
          ...
          <?php  $LayoutMain     = new JLayoutFile('wbc_blanco_template.navmain', $tpath.'/html/layouts');
    ...
    <div class="header-middle" role="heading"> 
        ...
        <div class="container<?php  echo ( $navbarHeaderWidth == 1 ) ? '-fluid' : '';?>">
           <div id="header-top-01" class="base-row <?php echo $bootstrap_rowclass; ?> d-none d-sm-block">
                <div class="<?php echo $bootstrap_colclass_mobil_xs . $col_xs_header_top01;?> <?php echo $bootstrap_colclass_mobil_sm . $col_sm_header_top01;?>  <?php echo $bootstrap_colclass . $col_md_header_top01; ?>">
    ...
    <?php if ( ($this->params->get('headerimg-select') == 1) && ( $this->params->get('headerimg') != NULL || $this->countModules('headerimg') ) ) : /*  wenn headerbild */?>   
        ...
        <?php  $Layoutheaderimg     = new JLayoutFile('wbc_blanco_template.headerimg', $tpath.'/html/layouts');
  ...
  <!-- ****************************************************************************************************** -->  
   ...
   <?php endif;?>
    ...
    <div class="contentarea <?php echo $classinside;?>"> 
        ...
        <div class="alert alert-danger" role="alert"><?php echo JText::_('TPL_WBC_BLANCO_J4_INFOTXTJS'); ?></div>
        <!--   Ende  -->
        </noscript>    
        ...
        if ( $this->countModules('vorInhalt-01-col') > 0 ) : /* wenn Modul mehrspaltig */ 
            ...
            $LayoutModules     = new JLayoutFile('wbc_blanco_template.cardmodules', $tpath.'/html/layouts');
...
<!-- ****************************    End Main Content ***************************************************** -->
  ...
  <footer id="wrap-footer" class="wbc-footer">
       ...
       <?php if ($this->countModules('footer-top')): ?>
        ...
        <div id="footer-middle" class="wbc-footer-middle">
          <div class="container-fluid">
          <?php  $LayoutFooter     = new JLayoutFile('wbc_blanco_template.footermodules', $tpath.'/html/layouts');
  ...
  <div id="gototop">
    <a class="mb-2 gototop shadow-sm d-inline-flex justify-content-center align-items-center" href="#top" ><i class="<?php echo $faclass; ?> fa-chevron-up"></i> <span class="sr-only"><?php echo JText::_('TPL_WBC_BLANCO_J4_TOP'); ?></span></a>
  </div>

  <div id="gototop-mobil" class="d-flex d-sm-none shadow-sm p-1 fixed-bottom">
    <a class="gototop" href="#top"><i class="<?php echo $faclass; ?> fa-chevron-up"></i><span class="sr-only"> <?php echo JText::_('TPL_WBC_BLANCO_J4_TOP'); ?></span></a>
...
if (  $offcanvas == 1 &&  $this->countModules('offcanvas'))  :
    ...
    $LayoutOffcanvas     = new JLayoutFile('wbc_blanco_template.hcoffcanvas', $tpath.'/html/layouts');
...
<?php   $LayoutSidebar     = new JLayoutFile('wbc_blanco_template.fixedsidebars', $tpath.'/html/layouts');
